...
public class EditorActivity extends AppCompatActivity implements LoaderManager.LoaderCallbacks<Cursor> {
    ...
    // id of a particular Loader used in this component
    ...
    private void savePet() {
        ...
        if (mCurrentPetUri == null) {
            // This is a new pet, so insert a new pet into the provider, returning the content URI
            // for the new pet.
    ...
    private void deletePet() {
        ...
        if (mCurrentPetUri != null) {
            ...
            if (rowsDeleted == 0) {
                ...
                // Otherwise, the deletion was successful and can display a toast.
    ...
    public boolean onPrepareOptionsMenu(Menu menu) {
        // If this is a new pet, hide the "Delete" item.
        if (mCurrentPetUri == null) {
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        switch (item.getItemId()) {
            ...
            case R.id.action_delete:
                // Show a dialog that notifies the user that the pet have been deleted.
            ...
            case android.R.id.home:
                ...
                DialogInterface.OnClickListener discardButtonClickListener = new DialogInterface.OnClickListener() {
                    ...
                    public void onClick(DialogInterface dialog, int which) {
                        // User click "Discard" button, navigate to the parent activity
    ...
    public void onLoadFinished(Loader<Cursor> loader, Cursor cursor) {
        ...
        if (cursor.moveToFirst()) {
            ...
            // Gender is a drowdown spinner, so map the constant value from the database into on of
            // the dropdown options(0 is Unknown, 1 is Male, 2 is Female).
            // Than call setSelection() so that option is displayed on the screen as the current selection.
            switch (gender) {
